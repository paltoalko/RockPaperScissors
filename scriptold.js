// function that hides the showcase
const hideShowcase = document.querySelector('.showcase');
const showGameTab = document.querySelector('.gametab')

document.getElementById("action").addEventListener("click", function() {
    hideShowcase.style.display = "none";
    showGameTab.style.display = "block";
...
//     if (computerSelection.toLowerCase() === playerSelection.toLowerCase() && computerSelection.toLowerCase()) 
